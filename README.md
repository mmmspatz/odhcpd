...
| dhcpv6_pd_exclude	|bool	| 0	| Allow delegation of a prefix containing the longer on-link prefix (RFC6603 Prefix Exclude Option.) Potentially allows an interface's entire delegation to be forwared. |
